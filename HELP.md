...
This project uses [Testcontainers at development time](https://docs.spring.io/spring-boot/4.0.0-M2/reference/features/dev-services.html#features.dev-services.testcontainers).
